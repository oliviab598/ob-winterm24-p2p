...
Inventory class keeps track of our commissions, owned artworks, and artworks pending exchange.
"""
import random
...
class Inventory:
    ...
    def __init__(self) -> None:
        ...
        self.artworks_pending_exchanges = set()
    ...
    def add_pending_exchange(self, exchange_key, exchange_offer):
        ...
        self.artworks_pending_exchanges.add(exchange_offer.artwork_id)
    ...
    def get_artwork_to_exchange(self):
        ...
        available_artworks = [
            ...
            if artwork.key not in self.artworks_pending_exchanges
        ]
